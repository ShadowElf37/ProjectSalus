    ...
    def call(self):
        ...
        self.response.attach_file('/accounts/landing.html', cache=False,
                                  ...
                                  next_class_meta=snippet('next-class-info-2',
                                                           ...
                                                           teacher=grades.get(nextclass[1]['id'], {'teacher': 'Data locked in grades'}).get('teacher'),
                                                           email=grades.get(nextclass[1]['id'], {'teacher': 'Data locked in grades'}).get('teacher-email'),
                                                           start=start,
